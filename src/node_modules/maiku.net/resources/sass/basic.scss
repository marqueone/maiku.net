...
#initial {
  ...
  .layouts {
    ...
    padding: 0 20px;
    margin-bottom: 25px;
    p {font-size: 12px; font-weight: 500; color: $color12;}
    .demo-image-wrap {
...
.dividewhite5 {  height: 50px;  }
.dividewhite6 {  height: 60px;  }
.dividewhite7 {  height: 70px;  }
...
.padding-30   {padding: 30px 30px 30px 30px;}
.padding-0-30-30-0 {padding: 0 30px 30px 0;}
.padding-30-30-30-0 {padding: 30px 30px 30px 0;}
.padding-40   {padding: 30px 40px 30px 40px;}
.padding-44   {padding: 44px 30px 44px 30px;}
.padding-50   {padding: 50px 50px 50px 50px;}
.padding-60   {padding: 60px 60px 60px 60px;}
.padding-0-15-0-0 { padding-right: 15px; }
...
input, textarea {
  ...
  &:focus {  outline: 0; border-color: $color10;}
}
...
@mixin block-big-margins      {  padding: 160px 0 160px 0;  }
@mixin block-regular-margins  {  padding: 130px 0 130px 0;  }
@mixin block-short-margins    {  padding: 100px 0 100px 0;  }
@mixin infoblock-margins      {  margin: 0 0 24px 0;  }
@mixin block-null-margins     {  margin: 0;  }
@mixin footer-margins         {  padding: 60px 0 0 0;    }

.e-block-big    {  @include block-big-margins;  }
.e-block-regular    {  @include block-regular-margins;  }
.e-block-short      {  @include block-short-margins;    }
.e-block-null       {  @include block-null-margins;     }
.e-block-light {
  background: $color01;
  color: $color10;
  p, h2, h3, h4, h5 {  color: $color10;  }
  a, .infoblock a   {  color: $color10;
    &:hover {
      color: $hovercolor;
      text-decoration: none;
    }
...
@media (max-width: 991px) {
  ...
  .flex-column {width: 100% !important;}
}
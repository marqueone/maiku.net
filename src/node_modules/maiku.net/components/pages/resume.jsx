                                                ...
                                                <tr>
                                                    <td>
                                                        <ul>
                                                            ...
                                                            {skills.filter(item => item.type === "language").map((item, key) =>
                                                                <SkillSet key={encode().value(`${item.name}-${key}`)} name={item.name} level={item.level} />
                                                            )}
                                                        </ul>
                                                        <ul>
                                                            <li><h4>Software</h4></li>
                                                            {skills.filter(item => item.type === "software").map((item, key) =>
                                                                <SkillSet key={encode().value(`${item.name}-${key}`)} name={item.name} level={item.level} />
                                                            )}
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            ...
                                                            {skills.filter(item => item.type === "framework").map((item, key) =>
                                                                <SkillSet key={encode().value(`${item.name}-${key}`)} name={item.name} level={item.level} />
                                                            )}
                                                        </ul>
                                                        <ul>
                                                            <li><h4>Operating Systems</h4></li>
                                                            {skills.filter(item => item.type === "os").map((item, key) =>
                                                                <SkillSet key={encode().value(`${item.name}-${key}`)} name={item.name} level={item.level} />
                                                            )}
                                                        </ul>
                                                    </td>

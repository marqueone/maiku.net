								...
								<div className="col-md-9 nopadding">
									...
									<section className="inner-section light bg-color01">
										<div className="padding-50">
											...
											<div className="row">
												...
												>
													{facts.sort((current, next) => (current.order - next.order)).map(item => (
														<ResumeFact
															key={item._id}
															label={item.label}
															value={item.fact}
									...
									<section id="timeline" className="light inner-section bg-color01">
										...
										<div className="padding-50">
											...
											{employment.sort((current, next) => (current.order - next.order)).map(employer => (
												<ul className="timeline-vert timeline" key={employer._id}>
													...
													{_.has(employer, "projects")
														? employer.projects.sort((current, next) => (current.order - next.order)).map(project => (
									...
									<section id="timeline" className="light inner-section bg-color01">
										<div className="padding-50">
											...
											<ul className="timeline-vert timeline">
												{education.sort((current, next) => (current.order - next.order)).map(item => (
													<ResumeSchool
														key={item._id}
														start={item.start}
														end={item.end}

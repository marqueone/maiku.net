...
export default class Home extends Component {
    ...
    render() {
        ...
        const employment = this.state.employment.map(item => ({ current: item.current, start: item.start, end: item.end, employer: item.company, position: item.position }));
            ...
            <Layout>
                ...
                <div className="content-wrap">
                    ...
                    <section className="container-fluid" data-section="home">
                        ...
                        <div className="row">
                            <div className="col-md-10 nopadding"></div>
                            <div className="col-md-2 col-sm-12 nopadding">
                                <div className="ui-block-color05 cv-pdf"
                        ...
                        <div className="row flex-row">
                            <div className="col-md-3 nopadding">
                                <div className="padding-0-30-30-0 dot-block"
                                    data-animation-origin="top"
                                    data-animation-duration="300"
                                    ...
                                    {employment.map((item, key) => 
                                        <EmploymentPosition 
                                            key={encode().value(item)}
                                            start={item.start}
                                            end={item.end}
                            ...
                            <div id="personal-2" className="col-md-6 flex-column light nopadding">
                                ...
                                {/*
<a href="resume.html" className="col-md-6 flex-column p-grid-item nopadding">
                                                <div className="flex-panel dot-block padding-30-30-30-0"
                                                    data-animation-origin="left"
                                                    data-animation-duration="300"
                                                    data-animation-delay="1200"
                                                    data-animation-distance="50px">
                                                    <div className="p-icon ui-block-color05"></div>
                                                    <span className="uppercase">Position</span>
                                                    <p className="">Head of UI/Ux Department</p>
                                                </div>
                                            </a>
                                */}
                        ...
                        {about !== "" 
                            ...
                            <div className="col-md-6 nopadding dot-block"

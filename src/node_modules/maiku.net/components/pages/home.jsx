...
export default class Home extends Component {
    ...
    render() {
        ...
        const employment = this.state.data.employment.map(item => ({ _id: item._id, current: item.current, start: item.start, end: item.end, employer: item.company, position: item.position }));

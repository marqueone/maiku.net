...
export default class Admin extends Component {
	...
	addSkill = skill => {
		const skills = !this.state.data.skills ? [].concat(skill) : this.state.data.skills.concat(skill);
	...
	addInfo = information => {
		const info = !this.state.data.info ? [].concat(information) : this.state.data.info.concat(information);
	...
	//-- facts
	addFact = fact => {
		const facts = !this.state.data.facts ? [].concat(fact) : this.state.data.facts.concat(fact);
	...
	addEducation = school => {
		const education = !this.state.data.education ? [].concat(school) : this.state.data.education.concat(school);

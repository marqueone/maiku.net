...
export default class Admin extends Component {
	...
	add = (type, value) => {
		const items = !this.state.data[type] ? [value] : this.state.data[type].concat(value);
	...
	update = (type, value) => {
		const item = this.state.data[type].find(x => x._id === value._id);
		const result = Object.assign({}, item, value);
		const items = this.state.data[type].filter(x => x !== item).concat(result);

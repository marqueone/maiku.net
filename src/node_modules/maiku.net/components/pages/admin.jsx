        ...
        return (
            <Layout>
                <div className="content-wrap">
                    ...
                    {/*//-- remove me later
                    <Link to="/admin/blah">go to blah</Link>*/}
                                        ...
                                        <div className="padding-50">
                                            ...
                                            <div className="row">
                                                <div>
                                                    ...
                                                    <SectionHeader
                                                        toggled={this.state.section === "about"}
                                                        toggleSection={this.toggleSection}
                                                        name="about"
                                                    />
                                                    <SectionHeader
                                                        toggled={this.state.section === "info"}
                                                        toggleSection={this.toggleSection}
                                                        name="info"
                                                    />
                                                    <SectionHeader
                                                        toggled={this.state.section === "facts"}
                                                        toggleSection={this.toggleSection}
                                                        name="facts"
                                                    />
                                                    <SectionHeader
                                                        toggled={this.state.section === "employment"}
                                                        toggleSection={this.toggleSection}
                                                        name="employment"
                                                    />
                                                    <SectionHeader
                                                        toggled={this.state.section === "education"}
                                                        toggleSection={this.toggleSection}
                                                        name="education"
                                                    />
                                                    <SectionHeader
                                                        toggled={this.state.section === "skills"}
                                                        toggleSection={this.toggleSection}
                                                        name="skills"
                                                        isEnd={true}
                                                    />
